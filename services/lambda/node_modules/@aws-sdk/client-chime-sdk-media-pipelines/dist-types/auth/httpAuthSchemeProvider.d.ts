 ...
 * @internal
 */
export interface ChimeSDKMediaPipelinesHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<ChimeSDKMediaPipelinesClientResolvedConfig, HandlerExecutionContext, ChimeSDKMediaPipelinesHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultChimeSDKMediaPipelinesHttpAuthSchemeParametersProvider: (config: ChimeSDKMediaPipelinesClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<ChimeSDKMediaPipelinesHttpAuthSchemeParameters>;
/**
 * @internal
 */
