...
class VideoCodecCapability {
     ...
     */
    fmtpLineMatches(line, expectedPayloadType) {
        ...
        if (this.codecName === 'H264') {
            ...
            const modifiedCodecCapabilityFmtpLine = codecCapabilityFmtpLine.replace(profileLevelIdRegex, 'profile-level-id=$1');
            const modifiedLine = line.replace(profileLevelIdRegex, 'profile-level-id=$1');
            return modifiedLine.startsWith(`a=fmtp:${expectedPayloadType} ${modifiedCodecCapabilityFmtpLine}`);
        }
    ...
    static fromSignaled(capability) {
        switch (capability) {
            ...
            case SignalingProtocol_1.SdkVideoCodecCapability.H264_BASELINE_PROFILE:
            ...
            case SignalingProtocol_1.SdkVideoCodecCapability.H264_CONSTRAINED_BASELINE_PROFILE:
                return VideoCodecCapability.h264ConstrainedBaselineProfile();
            case SignalingProtocol_1.SdkVideoCodecCapability.H264_MAIN_PROFILE:
                return VideoCodecCapability.h264MainProfile();
            case SignalingProtocol_1.SdkVideoCodecCapability.H264_HIGH_PROFILE:
                return VideoCodecCapability.h264HighProfile();
            case SignalingProtocol_1.SdkVideoCodecCapability.H264_CONSTRAINED_HIGH_PROFILE:
                return VideoCodecCapability.h264ConstrainedHighProfile();
            case SignalingProtocol_1.SdkVideoCodecCapability.VP9_PROFILE_0:
                return VideoCodecCapability.vp9Profile0();
            case SignalingProtocol_1.SdkVideoCodecCapability.AV1_MAIN_PROFILE:
                return VideoCodecCapability.av1Main();
            default:
                return undefined;
        }
