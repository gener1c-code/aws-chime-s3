...
const SignalingClientEvent_1 = __importDefault(require("./SignalingClientEvent"));
const SignalingClientEventType_1 = __importDefault(require("./SignalingClientEventType"));
/**
...
class DefaultSignalingClient {
    ...
    convertSignalingClientVideoSubscriptionConfiguration(config) {
        ...
        switch (config.qualityAdaptationPreference) {
            case VideoQualityAdaptationPreference_1.default.Balanced:
                signalConfig.qualityAdaptationPreference = SignalingProtocol_js_1.SdkVideoQualityAdaptationPreference.BALANCED;
                break;
            case VideoQualityAdaptationPreference_1.default.MaintainFramerate:
                signalConfig.qualityAdaptationPreference =
                    SignalingProtocol_js_1.SdkVideoQualityAdaptationPreference.MAINTAIN_FRAMERATE;
                break;
            case VideoQualityAdaptationPreference_1.default.MaintainResolution:
                signalConfig.qualityAdaptationPreference =
                    SignalingProtocol_js_1.SdkVideoQualityAdaptationPreference.MAINTAIN_RESOLUTION;
                break;
            default:
                signalConfig.qualityAdaptationPreference = SignalingProtocol_js_1.SdkVideoQualityAdaptationPreference.BALANCED;
        }
