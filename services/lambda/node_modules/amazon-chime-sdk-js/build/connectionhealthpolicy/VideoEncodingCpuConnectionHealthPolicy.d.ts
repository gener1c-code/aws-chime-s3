...
export default class VideoEncodingCpuConnectionHealthPolicy extends BaseConnectionHealthPolicy implements ConnectionHealthPolicy {
    private readonly consecutiveHighEncodeCpuThreshold;
    private readonly highEncodeCpuMsThreshold;
    private consecutiveHighEncodeCpuCnt;
